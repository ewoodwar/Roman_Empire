...
pdot(2,:)=pi_2 - ((beta_2*p(2))/(p(4)+p(2)))+ alpha_12*p(1) - alpha_21*p(2)+ omega*p(6);
pdot(3,:)= beta_1*p(2)+ gamma_21*p(4)-gamma_12*p(3)-sigma_12*p(4);
pdot(4,:)=beta_2*p(2)-gamma_21*p(4)+ gamma_12*p(3) - sigma_21*p(4);
